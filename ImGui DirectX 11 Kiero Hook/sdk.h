...
namespace Offsets
{
	uintptr_t WeaponLateUpdate = 0x0; // Use This to Hold Offsets for Functions
	uintptr_t FindShader = 0x0; // Use This to Hold Offsets for Functions
	uintptr_t GetHardwareIdentifier = 0x0; // Use This to Hold Offsets for Functions
	uintptr_t GetDeviceUniqueIdentifier = 0x0; // Use This to Hold Offsets for Functions
	uintptr_t IsDebugBuild = 0x0; // Use This to Hold Offsets for Functions
	uintptr_t setdeveloperConsoleVisible = 0x0; // Use This to Hold Offsets for Functions
}
